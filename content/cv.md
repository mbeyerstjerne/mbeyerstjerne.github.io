...
- Managing complex cargo insurance claims from start to end, examining relevant documentation and consulting with business partners to determine liability, negotiating settlement terms with claimants to ensure cost-effective and satisfactory resolution.
- Performing ad-hoc queries upon using database tools as a claims tool superuser, extracting and analysing datasets in order to identify trends, and providing valuable insights to help shape future risk management policies.
- Analysing cargo claims data using Excel to identify trends in liability and settlement of claims, producing reports and visualisations to lend a data-based insight into decision-making processes within the claims management team.
...
- Analysed stellar spectra data from the GALAH DR3 galactic survey, using statistical analysis and data visualization techniques to examine the chemical distribution of stars in the Milky Way, and to determine the rate of lithium destruction in red-clump stars.
- Compiled literature on relevant methods within galactic archaeology, adapting previous efforts to simulate stellar chemical abundances to develop a well-rounded research methodology, improving research comprehension and synthesis skills.
- Utilised Python’s Pandas and astropy packages, along with TOPCAT, to manipulate large tabular data, and applying pre-processing techniques when necessary to ensure reliability of subsequent analyses.
...
- Marked assessments for online courses in astronomy and general education courses in science, providing feedback and assistance to over 150 students concurrently over the course of a 10-week term.
- Supported senior teaching staff by completing administrative tasks and preparing educational materials for students.
...
- Coordinated funding initiatives through the university’s student organisation to hold events catered towards students passionate about physics and astronomy.
- Worked with society executives to develop compliant event management protocols during the COVID-19 outbreak.
...
**Documentation and markup**: LaTeX
